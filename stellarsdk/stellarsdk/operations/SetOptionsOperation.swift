...
class SetOptionsOperation: Operation {
    ...
    public var clearFlags:Flags!
    public var setFlags:Flags!
    ...
    public required init(from decoder: Decoder) throws {
        ...
        clearFlags = try values.decodeIfPresent(Flags.self, forKey: .clearFlags)
        setFlags = try values.decodeIfPresent(Flags.self, forKey: .setFlags)
