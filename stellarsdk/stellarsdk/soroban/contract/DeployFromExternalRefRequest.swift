...
public final class DeployFromExternalRefRequest: Sendable {
    ...
    ///
    public init(rpcUrl: String, network: Network, sourceAccountKeyPair: KeyPair, executableOwner: String, tag: String, constructorArgs: [SCValXDR]? = nil, salt: WrappedData32? = nil, methodOptions: MethodOptions = MethodOptions(), enableServerLogging: Bool) {
        self.rpcUrl = rpcUrl
