...
public class LiquidityPoolWithdrewEffectResponse: EffectResponse {
    ...
    public var liquidityPool:LiquidityPoolWithdrewResponse
    ...
    public required init(from decoder: Decoder) throws {
        ...
        liquidityPool = try values.decode(LiquidityPoolWithdrewResponse.self, forKey: .liquidityPool)
        try super.init(from: decoder)
    }
}

public class LiquidityPoolWithdrewResponse: NSObject, Decodable {
