//
//  OZSmartAccountTypesTests.swift
//  stellarsdkUnitTests
//
...
final class OZSmartAccountTypesTests: XCTestCase {
    ...
    // MARK: - OZExternalSigner.webAuthn
    ...
    func test_external_signer_webauthn_rejects_wrong_size_pubkey_throws_invalid_input() {
        ...
        do {
            _ = try OZExternalSigner.webAuthn(
                verifierAddress: validContractC,
                publicKey: publicKey,
    ...
    // MARK: - OZExternalSigner ctor validation
    ...
    // MARK: - OZExternalSigner equality / hashing
    ...
    func test_external_signer_equals_constant_time_for_keydata() throws {
        ...
        let signerA = try OZExternalSigner.ed25519(verifierAddress: validContractC, publicKey: key1)
        let signerB = try OZExternalSigner.ed25519(verifierAddress: validContractC, publicKey: key2)
        let signerC = try OZExternalSigner.ed25519(verifierAddress: validContractC, publicKey: key3)
        ...
        let signerD = try OZExternalSigner.ed25519(verifierAddress: validContractC, publicKey: key1)
    ...
    func test_externalSigner_constantTimeEquals_length_mismatch_256_vs_0_returns_false() throws {
        ...
        // on an immutable struct; instead exercise the helper through the OZExternalSigner
        ...
        let signerLong = try OZExternalSigner(verifierAddress: validContractC, keyData: veryLongKey)
        ...
        XCTAssertNotEqual(signerLong, signerShort,
                          "OZExternalSigner with key lengths whose XOR truncates to 0 must not compare equal")
        // Symmetric direction
        ...
        let signer256 = try OZExternalSigner(verifierAddress: validContractC, keyData: longKey)
        XCTAssertNotEqual(signer256, signerShort,
                          "256-byte vs 1-byte OZExternalSigner must compare unequal")
    }
