...
final class AllowCredentialTests: XCTestCase {

    // MARK: - Construction

    func test_allow_credential_construction_with_id_only() {
        let id = Data([0x01, 0x02, 0x03])
        let credential = AllowCredential(id: id)
    ...
    func test_allow_credential_construction_with_id_and_transports() {
        ...
        let credential = AllowCredential(id: id, transports: transports)
    ...
    func test_allow_credential_construction_with_explicit_null_transports() {
        ...
        let credential = AllowCredential(id: id, transports: nil)
    ...
    func test_allow_credential_equals_same_byte_content() {
        ...
        let credential1 = AllowCredential(id: id1, transports: transports)
        let credential2 = AllowCredential(id: id2, transports: transports)

        XCTAssertEqual(credential1, credential2)
    }

    func test_allow_credential_equals_with_null_transports() {
        let credential1 = AllowCredential(id: Data([0x01, 0x02]), transports: nil)
        let credential2 = AllowCredential(id: Data([0x01, 0x02]), transports: nil)

        XCTAssertEqual(credential1, credential2)
    }

    func test_allow_credential_not_equal_when_ids_differ() {
        let credential1 = AllowCredential(id: Data([0x01, 0x02]))
        let credential2 = AllowCredential(id: Data([0x01, 0x03]))
    ...
    func test_allow_credential_not_equal_when_transports_differ() {
        ...
        let credential1 = AllowCredential(id: id, transports: ["internal"])
        let credential2 = AllowCredential(id: id, transports: ["usb"])
    ...
    func test_allow_credential_not_equal_null_transports_vs_empty_list() {
        let id = Data([0x01, 0x02])
        let withNull = AllowCredential(id: id, transports: nil)
        let withEmpty = AllowCredential(id: id, transports: [])
    ...
    func test_allow_credential_not_equal_one_null_other_non_null_transports() {
        let id = Data([0x01, 0x02])
        let withNull = AllowCredential(id: id, transports: nil)
        let withValue = AllowCredential(id: id, transports: ["hybrid"])
    ...
    func test_allow_credential_equals_with_self() {
        let credential = AllowCredential(
    ...
    func test_allow_credential_hashcode_differs_for_different_objects() {
        let credential1 = AllowCredential(id: Data([0x01]), transports: ["internal"])
        let credential2 = AllowCredential(id: Data([0x02]), transports: ["internal"])
    ...
    func test_allow_credential_hashcode_null_vs_non_null_transports_differs() {
        let id = Data([0x01, 0x02])
        let withNull = AllowCredential(id: id, transports: nil)
        let withValue = AllowCredential(id: id, transports: ["internal"])
    ...
    func test_allow_credential_from_id_creates_credential_with_null_transports() {
        ...
        let credential = AllowCredential.fromId(id)
    ...
    func test_allow_credential_from_id_equivalent_to_direct_construction() {
        ...
        let fromFactory = AllowCredential.fromId(id)
        let direct = AllowCredential(id: id)
    ...
    func test_allow_credential_from_ids_creates_list_with_all_null_transports() {
        ...
        let credentials = AllowCredential.fromIds(ids)
    ...
    func test_allow_credential_id_stored_by_reference_not_copied() {
        ...
        let credential = AllowCredential(id: originalId)
    ...
    func test_allow_credential_copy_of_id_is_independent() {
        ...
        var originalId = Data([0x01, 0x02, 0x03])
        let credential = AllowCredential(id: Data(originalId))
