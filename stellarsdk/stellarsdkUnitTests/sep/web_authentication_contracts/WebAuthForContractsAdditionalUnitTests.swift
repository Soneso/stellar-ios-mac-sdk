...
final class WebAuthForContractsAdditionalUnitTests: XCTestCase {
    ...
    let clientPrivateKey = "SBXFU2EMT2Y3IRGN2MSXIBIAXEPT77PYKN5HHQSDBLNCT7OCYYBA3G4L"

    // Client domain keys
    let clientDomainPublicKey = "GCEVW7ZFDIEHWLI7TKQITJPBYXF5XQWHVSXGYMCUYAI2XCGWGBSXAZQA"
    let clientDomainPrivateKey = "SCKL3JRQGDL356H7UBZBGJVJFMX6XQFMX52CXRGQVMYCEMZ5XQGQPMFJ"
