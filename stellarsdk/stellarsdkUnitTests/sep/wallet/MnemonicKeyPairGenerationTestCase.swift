//
//  MnemonicKeyPairGenerationTestCase.swift
//  stellarsdkTests
//
...
class MnemonicKeyPairGenerationTestCase: XCTestCase {
    ...
    // Note: Raw BIP-39/Ed25519 derivation tests are in Ed25519DerivationTestCase.swift
    // These tests verify the WalletUtils API wrapper
