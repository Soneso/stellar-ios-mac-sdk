...
class MnemonicKeyPairGeneration: XCTestCase {
    ...
    func test12WordBIPAndMasterKeyGeneration() {
        ...
        XCTAssertEqual(bip39Seed.base16EncodedString(), "e4a5a632e70943ae7f07659df1332160937fad82587216a4c64315a0fb39497ee4a01f76ddab4cba68147977f3a147b6ad584c41808e8238a07f6cc4b582f186")
        ...
        XCTAssertEqual(coinType.raw.base16EncodedString(), "e0eec84fe165cd427cb7bc9b6cfdef0555aa1cb6f9043ff1fe986c3c8ddd22e3")
        
        let account0 = coinType.derived(at: 0)
        let keyPair0 = try! KeyPair.init(seed: Seed(bytes: [UInt8](account0.raw)))
        ...
        let keyPair4 = try! KeyPair.init(seed: Seed(bytes: [UInt8](account4.raw)))
        ...
        let keyPair8 = try! KeyPair.init(seed: Seed(bytes: [UInt8](account8.raw)))
    ...
    func test24WordBIPAndMasterKeyGeneration() {
        ...
        XCTAssertEqual(bip39Seed.base16EncodedString(), "937ae91f6ab6f12461d9936dfc1375ea5312d097f3f1eb6fed6a82fbe38c85824da8704389831482db0433e5f6c6c9700ff1946aa75ad8cc2654d6e40f567866")
        ...
        XCTAssertEqual(coinType.raw.base16EncodedString(), "df474e0dc2711089b89af6b089aceeb77e73120e9f895bd330a36fa952835ea8")
    ...
    func test12WordWalletKeyPairGeneration() {
        ...
        let keyPair4 = try! WalletUtils.createKeyPair(mnemonic: mnemonic, passphrase: nil, index: 4)
        
        XCTAssertEqual(keyPair4.accountId, "GBCUXLFLSL2JE3NWLHAWXQZN6SQC6577YMAU3M3BEMWKYPFWXBSRCWV4")
        XCTAssertEqual(keyPair4.secretSeed, "SCPCY3CEHMOP2TADSV2ERNNZBNHBGP4V32VGOORIEV6QJLXD5NMCJUXI")
        
        let keyPair8 = try! WalletUtils.createKeyPair(mnemonic: mnemonic, passphrase: nil, index: 8)
    ...
    func test24WordWalletKeyPairGenerationWithPassphrase() {
        ...
        let keyPair2 = try! WalletUtils.createKeyPair(mnemonic: mnemonic, passphrase: "p4ssphr4se", index: 2)
        ...
        let keyPair4 = try! WalletUtils.createKeyPair(mnemonic: mnemonic, passphrase: "p4ssphr4se", index: 4)
        ...
        let keyPair8 = try! WalletUtils.createKeyPair(mnemonic: mnemonic, passphrase: "p4ssphr4se", index: 8)
