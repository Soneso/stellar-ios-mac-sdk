...
class SorobanAtomicSwapTest: XCTestCase {
    ...
    let aliceKeyPair = try! KeyPair(secretSeed: "SB4TQF4SU37PNXP2KZ54WU7RRP7XMJTFKHSCWSBTSVSSLSTCMBO3ZD6X") // GB5FIMKO5ZVEZY7F76KNYPMARKPO4ZFXFIWKIG43J7ZT3BC3RYTTPFMY
    let bobKeyPair = try! KeyPair(secretSeed: "SCPKAWY2M6P6SLJQVT5RFP5GXQHP6UJOIMO7VOZVKGYYCUE5RPW4DZK3") // GDQPWEF5KAVYDCSX6IPEUNWMFYVVQDRHRUCO3MHRNS6OXCEEJYFKMVKD
    let atomicSwapContractId = "CDYCP25C4UTJUCMDZTF5RTSW7R2RLD6GPIRF4QXJAWENOHHXMP7MC3Q3"
    let tokenAId  = "CDB7XEXNVA6OQJGDKWZMEOTMTK4JK5KBGMEA5HQZLTK2HPS4VHXB2GVU"
    let tokenBId = "CBGUAFCNIDST5SF2JHA277G3N2KK4MQSXIIMXMNUKU6CSWTDN7EHDWSM"
