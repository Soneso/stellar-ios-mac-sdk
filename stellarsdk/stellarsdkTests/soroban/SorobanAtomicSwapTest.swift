...
class SorobanAtomicSwapTest: XCTestCase {
    ...
    let aliceKeyPair = try! KeyPair(secretSeed: "SANO5KN54PY7ZWEFOJRTJI2YRVXIEWMSXG5HJPOY3SJC7S2A7XEXOREQ") // GB6BL7R3RNAR4XTG5ZY7AWDOEQQGPSH6X5YLJPHMJWM633WCUNZCO4IM
    let bobKeyPair = try! KeyPair(secretSeed: "SCTFSK6HXSEEDZJCKLUEMNS3FJN4SRVI6DJXSEXKIAXUT5X6I2H2ZRBL") // GBPTCW23R3B4FOQAX4AQJECG2BDXGN3ONOQ3LMYQMCVQ4NBJJSAVDLAY
    let atomicSwapContractId = "CB2T7YABGG7HC4RLE7ABI43RIXOAVUFPBPOGKVCS3XQAK3RMEZTB6TA2"
    let tokenAId  = "CB4PSFWX2SCNQNBURD4CFRX4TD3R3A6DXXFBY467WRIJFFEUFMCBIWYK"
    let tokenBId = "CBTLWW46KKTIKALBNW6B22ZEKS67SGVJHMOTMOZ4VEACCPXZL4PIK44J"
