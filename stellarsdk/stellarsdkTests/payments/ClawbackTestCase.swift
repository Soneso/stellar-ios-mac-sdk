...
class ClawbackTestCase: XCTestCase {
    ...
    override func setUp() {
        ...
        sdk.accounts.createTestAccount(accountId: donorAccountId) { (response) -> (Void) in
            switch response {
            case .success(_):
                self.sdk.accounts.getAccountDetails(accountId: donorAccountId) { (response) -> (Void) in
                    switch response {
    ...
    func testAll() {
        ...
        clawbackCalimableBalance()
        transactionClaimableBalanceClawbackXDR()
    }
    
    func setIssuerClawbackFlag() {
        XCTContext.runActivity(named: "setIssuerClawbackFlag") { activity in
    ...
    func changeTrustlines() {
        XCTContext.runActivity(named: "changeTrustlines") { activity in
    ...
    func sendIOM() {
        XCTContext.runActivity(named: "sendIOM") { activity in
    ...
    func clawbackIOM() {
        XCTContext.runActivity(named: "clawbackIOM") { activity in
    ...
    func transactionClawbackXDR() {
        XCTContext.runActivity(named: "transactionClawbackXDR") { activity in
    ...
    func setTrustlineFlags() {
        XCTContext.runActivity(named: "setTrustlineFlags") { activity in
    ...
    func transactionSetTrustlineFlagsXDR() {
        XCTContext.runActivity(named: "transactionSetTrustlineFlagsXDR") { activity in
    ...
    func clawbackCalimableBalance() {
        XCTContext.runActivity(named: "clawbackCalimableBalance") { activity in
    ...
    func transactionClaimableBalanceClawbackXDR() {
        XCTContext.runActivity(named: "transactionClaimableBalanceClawbackXDR") { activity in
