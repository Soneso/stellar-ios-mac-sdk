...
For more info, see also the sdk's [SEP-0006 test cases](https://github.com/Soneso/stellar-ios-mac-sdk/blob/master/stellarsdk/stellarsdkUnitTests/sep/transfer_server_protocol/TransferServerServiceUnitTests.swift).
