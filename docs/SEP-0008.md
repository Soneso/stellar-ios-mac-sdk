...
SDK's [SEP-08 test cases](https://github.com/Soneso/stellar-ios-mac-sdk/blob/master/stellarsdk/stellarsdkIntegrationTests/regulated_assets/RegulatedAssetsTestCase.swift).
