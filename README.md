...
```swift
.package(name: "stellarsdk", url: "git@github.com:Soneso/stellar-ios-mac-sdk.git", from: "3.0.6"),
```
...
```ogdl
github "soneso/stellar-ios-mac-sdk" ~> 3.0.6
```
