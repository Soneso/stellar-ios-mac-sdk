...
```ogdl
github "soneso/stellar-ios-mac-sdk" ~> 2.0.7
```
...
```swift
.package(name: "stellarsdk", url: "git@github.com:Soneso/stellar-ios-mac-sdk.git", from: "2.0.7"),
```
