...
```ogdl
github "soneso/stellar-ios-mac-sdk" ~> 2.4.6
```
...
```swift
.package(name: "stellarsdk", url: "git@github.com:Soneso/stellar-ios-mac-sdk.git", from: "2.4.6"),
```
