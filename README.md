...
```swift
.package(name: "stellarsdk", url: "git@github.com:Soneso/stellar-ios-mac-sdk.git", from: "3.2.5"),
```
...
```ogdl
github "soneso/stellar-ios-mac-sdk" ~> 3.2.5
```
